<template>
  <div class="sticky top-[-65px] z-50">
    <div class="bg-primary">
      <nav class="container flex flex-wrap items-center justify-between h-[60px]">
        ...
        <div class="flex flex-wrap items-center space-x-4 h-full gap-[10px] sm:gap-[30px]">
          ...
          <div class="flex items-center space-x-2">
            <img
              ...
              class="w-6 h-6 sm:w-auto sm:h-auto"
            />
            <span class="text-white text-sm sm:text-base">+998 (90) 123 45 67</span>
          </div>
        </div>
      </nav>
    </div>
          ...
          <div class="flex flex-wrap gap-[10px] sm:gap-[35px] items-center">
            <div class="flex items-center space-x-2 w-full sm:w-auto">
              <div class="relative w-full sm:w-auto">
                <button class="flex items-center justify-between px-2 py-1 border border-orange-400 text-orange-500 rounded w-full sm:w-[133px] h-[34px]">
                  <svg
                    width="10"
                    height="10"
                    viewBox="0 0 10 10"
            ...
            <div class="relative flex justify-between w-full sm:w-[435px] h-[36px] pt-[1px]">
              <input
                type="text"
                class="p-2 border border-orange-500 rounded-md focus:outline-none w-full h-[34px] pr-[40px]"
                placeholder="Поиск..."
              />
              <button class="absolute right-0 top-[1px] bg-orange-500 text-white rounded-r w-[36px] h-[34px] flex items-center justify-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="h-6 w-6"
                  fill="none"
